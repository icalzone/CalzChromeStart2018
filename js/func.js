    ...
    function randImage() {
        ...
        //             $('#altBg').css('background-image', 'url(http://www.ellzzoo.com/bkgnds/image_1.jpg)');
        //             chrome.storage.sync.set({ imageInteger: imageInteger+1 });
        //         } else if(imageInteger == 329){
        //             $('#bg').css('background-image', 'url(http://www.ellzzoo.com/bkgnds/image_'+imageInteger+'.jpg)');
        //             var nextImage = 0;
        ...
        //             $('#altBg').css('background-image', 'url(http://www.ellzzoo.com/bkgnds/image_'+nextImage+'.jpg)');
        //             chrome.storage.sync.set({ imageInteger: nextImage });
        //         }
        //         var pictureLocation = document.getElementById('downloadImage');
        //         pictureLocation.innerHTML = "<a download='leoh_image_"+randomImage+".jpg' href='http://www.ellzzoo.com/bkgnds/image_" + imageInteger + ".jpg'>Download Image</a>";

        //     });
            // var randomImage = Math.floor(Math.random() * 314) + 1;
            // $('#bg').css('background-image', 'url(http://www.ellzzoo.com/bkgnds/image_' + randomImage + '.jpg)');
        } else  {
            var randomImage = Math.floor(Math.random() * 314) + 1;
            $('#bg').css('background-image', 'url(http://www.ellzzoo.com/bkgnds/image_' + randomImage + '.jpg)');
        }
